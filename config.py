...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/BADNAM07123/Badnam_music",
)
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/team_badnam_support_ll")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/jnzegd.jpg"
)
PING_IMG_URL = getenv(
